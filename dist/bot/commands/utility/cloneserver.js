...
export default {
    ...
    async execute(message, args) {
        ...
        if (!originalGuildID)
            return message.channel.send("❌ Please specify the ID of the server to clone.");
        try {
            ...
            const hasPermissions = permissionsNeeded.every((permission) => originalGuild.me.permissions.has(permission));
            if (!hasPermissions) {
